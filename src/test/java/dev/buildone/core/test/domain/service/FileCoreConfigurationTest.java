...
@ActiveProfiles("file")
public class FileCoreConfigurationTest extends AbstractCoreConfigurationTest {
  public FileCoreConfigurationTest(@Autowired FrontendService frontendService,
